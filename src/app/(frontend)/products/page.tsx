  ...
  return (
    <div className="pt-32 pb-32 bg-candera-linen min-h-screen">
      ...
      <div className="container">
        ...
        <span className="eyebrow block mb-8">{resultLabel}</span>
        ...
        {products.docs.length === 0 && (
          <div className="text-center py-24">
            ...
            <a href="/products" className="text-[11px] font-bold uppercase tracking-[.3em] text-candera-obsidian hover:text-candera-ember-strong transition-colors">
              View all vessels →
            </a>
          </div>
        )}
