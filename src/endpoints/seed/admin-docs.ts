...
const managingEtsySync: Doc = {
  ...
  content: root(
    heading('How Etsy Sync Works', 'h2'),
    para(
    ...
    heading('After Sync: What to Edit', 'h2'),
    para(
    ...
    heading('Publishing a Product', 'h2'),
    para(
...
const runningSeedProcess: Doc = {
  ...
  content: root(
    heading('WARNING: Destructive Operation', 'h2'),
    para(
    ...
    heading('Required Environment Variables', 'h2'),
    bulletList(
...
const usingDraftsAndPreview: Doc = {
  ...
  content: root(
    ...
    heading('Scheduling a Publish Date', 'h2'),
    para(
