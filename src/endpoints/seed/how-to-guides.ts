...
export const candleCare101 = ({ heroImage }: { heroImage: Media }): HowToGuide => ({
  ...
  content: root(
    heading('Trim Your Wick Before Every Burn', 'h2'),
    para(
    ...
    heading('The First Burn Sets the Memory', 'h2'),
    para(
    ...
    heading('Burn Time Guidelines', 'h2'),
    para(
    ...
    heading('Store Out of Direct Light', 'h2'),
    para(
...
export const firstBurnRitual = ({ heroImage }: { heroImage: Media }): HowToGuide => ({
  ...
  publishedAt: new Date('2026-06-22').toISOString(),
  content: root(
    heading('Why the First Burn Matters', 'h2'),
    para(
    ...
    heading('Setting the Wax Memory', 'h2'),
    para(
    ...
    heading('What You Will Notice', 'h2'),
    para(
    ...
    heading('Extinguishing Properly', 'h2'),
    para(
    ...
    heading('After the First Burn', 'h2'),
    para(
...
export const readingScentProfile = ({ heroImage }: { heroImage: Media }): HowToGuide => ({
  ...
  publishedAt: new Date('2026-06-22').toISOString(),
  content: root(
    heading('The Architecture of Fragrance', 'h2'),
    para(
    ...
    heading('Reading the Atmosphere Tag', 'h2'),
    para(
    ...
    heading('Cold Throw vs. Hot Throw', 'h2'),
    para(
