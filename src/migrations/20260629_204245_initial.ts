...
export async function up({ db, payload: _payload, req: _req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_archive_relation_to" AS ENUM('posts', 'products');
  ...
  CREATE TYPE "public"."enum__pages_v_blocks_archive_relation_to" AS ENUM('posts', 'products');
  CREATE TYPE "public"."enum__pages_v_version_hero_type" AS ENUM('none', 'highImpact', 'mediumImpact', 'lowImpact');
  CREATE TYPE "public"."enum__pages_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_posts_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__posts_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_products_product_type" AS ENUM('candle', 'vintage', 'custom');
  ...
  CREATE TYPE "public"."enum__products_v_version_product_type" AS ENUM('candle', 'vintage', 'custom');
  ...
  CREATE TYPE "public"."enum_payload_folders_folder_type" AS ENUM('folders', 'media');
  ...
  CREATE TABLE "pages_blocks_storefront_hero" (
  	...
  	"media_id" integer,
  	"primary_cta_label" varchar DEFAULT 'Shop the Collection',
  	"primary_cta_url" varchar DEFAULT '#collection',
  	"secondary_cta_label" varchar DEFAULT 'Take the Scent Quiz',
  	"secondary_cta_url" varchar DEFAULT '#scent-quiz',
  	"show_status_card" boolean DEFAULT true,
  	"ethos_card_eyebrow" varchar DEFAULT 'The Slow Pour',
  	"ethos_card_body" varchar DEFAULT 'No factories. No white labeling. Just real pressed botanicals and slow light.',
  	"ethos_card_footer_label" varchar DEFAULT 'Exclusively on Etsy',
  	"ethos_card_link_label" varchar DEFAULT 'Read Journal',
  	"status_card_title" varchar DEFAULT 'Featured Candle',
  	"status_card_price" varchar DEFAULT '$38',
  	"status_card_subtitle" varchar DEFAULT 'Wild Lilac (8 oz)',
  	"status_card_status" varchar DEFAULT 'Limited Batch',
  	"status_card_ships" varchar,
  	"status_card_link_url" varchar DEFAULT '/products/wild-lilac',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "products" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  	"product_type" "enum_products_product_type" DEFAULT 'candle',
  	"tagline" varchar,
  	"is_customizable" boolean DEFAULT false,
  	"customization_label" varchar,
  	"description" jsonb,
  	"atmosphere_id" integer,
  	"burn_time" varchar DEFAULT '60 Hours',
  	"scent_profile_top" varchar,
  	"scent_profile_heart" varchar,
  	"scent_profile_base" varchar,
  	"meta_title" varchar,
  	"meta_image_id" integer,
  	"meta_description" varchar,
  	"etsy_listing_id" numeric,
  	"etsy_title" varchar,
  	"raw_etsy_description" varchar,
  	"etsy_primary_image_id" integer,
  	"generate_slug" boolean DEFAULT true,
  	"slug" varchar,
  	"product_tag" "enum_products_product_tag",
  	"vessel" varchar,
  	"price" numeric,
  	"currency" "enum_products_currency" DEFAULT 'USD',
  	"price_synced_at" timestamp(3) with time zone,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "_products_v" (
  	...
  	"parent_id" integer,
  	"version_title" varchar,
  	"version_product_type" "enum__products_v_version_product_type" DEFAULT 'candle',
  	"version_tagline" varchar,
  	"version_is_customizable" boolean DEFAULT false,
  	"version_customization_label" varchar,
  	"version_description" jsonb,
  	"version_atmosphere_id" integer,
  	"version_burn_time" varchar DEFAULT '60 Hours',
  	...
  	"version_etsy_title" varchar,
  	"version_raw_etsy_description" varchar,
  	"version_etsy_primary_image_id" integer,
  	"version_generate_slug" boolean DEFAULT true,
  	"version_slug" varchar,
  	"version_product_tag" "enum__products_v_version_product_tag",
  	"version_vessel" varchar,
  	"version_price" numeric,
  	"version_currency" "enum__products_v_version_currency" DEFAULT 'USD',
  	"version_price_synced_at" timestamp(3) with time zone,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  ...
  CREATE TABLE "payload_mcp_api_keys" (
  	...
  	"label" varchar,
  	"description" varchar,
  	"folders_find" boolean DEFAULT false,
  	"folders_create" boolean DEFAULT false,
  	"folders_update" boolean DEFAULT false,
  	"folders_delete" boolean DEFAULT false,
  	...
  	"briefs_find" boolean DEFAULT false,
  	"briefs_create" boolean DEFAULT false,
  	"briefs_update" boolean DEFAULT false,
  	"briefs_delete" boolean DEFAULT false,
  	...
  	"scent_profiles_find" boolean DEFAULT false,
  	"scent_profiles_create" boolean DEFAULT false,
  	"scent_profiles_update" boolean DEFAULT false,
  	"scent_profiles_delete" boolean DEFAULT false,
  	"documentation_find" boolean DEFAULT false,
  	"documentation_create" boolean DEFAULT false,
  	"documentation_update" boolean DEFAULT false,
  	"documentation_delete" boolean DEFAULT false,
  	"how_to_guides_find" boolean DEFAULT false,
  	"how_to_guides_create" boolean DEFAULT false,
  	"how_to_guides_update" boolean DEFAULT false,
  	"how_to_guides_delete" boolean DEFAULT false,
  	...
  	"site_theme_find" boolean DEFAULT false,
  	"site_theme_update" boolean DEFAULT false,
  	"studio_info_find" boolean DEFAULT false,
  	"studio_info_update" boolean DEFAULT false,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"categories_id" integer,
  	"users_id" integer,
  	"etsy_tokens_id" integer,
  	"briefs_id" integer,
  	"quizzes_id" integer,
  	"scent_profiles_id" integer,
  	"documentation_id" integer,
  	"how_to_guides_id" integer,
  ...
  CREATE TABLE "site_theme" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"color_scheme" "enum_site_theme_color_scheme" DEFAULT 'rose-conversion' NOT NULL,
  	"font_set" "enum_site_theme_font_set" DEFAULT 'default' NOT NULL,
  	"hero_layout" "enum_site_theme_hero_layout" DEFAULT 'centered-editorial',
  	"product_card_density" "enum_site_theme_product_card_density" DEFAULT 'boutique-grid',
  	"section_mood" "enum_site_theme_section_mood" DEFAULT 'light-editorial',
  	"cta_style" "enum_site_theme_cta_style" DEFAULT 'conversion-filled',
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
