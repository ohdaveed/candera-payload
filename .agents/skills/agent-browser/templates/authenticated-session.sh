...
# ================================================================
# This template reads the login credentials from the environment, not the
# script. See the "Environment variables" section in the header above for the
# exact names; both vars are intended to be supplied at invocation time.
#
# echo "Opening login page..."
# RESULT=$(infsh app run agent-browser --function open --session new --input '{
#   "url": "'"$LOGIN_URL"'",
