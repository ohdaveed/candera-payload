...
export const RunInput = z
  .object({
    texts: z.array(z.string()).optional().describe('Texts to process.'),
    textsFile: z.any().optional().describe('File containing texts (one per line).'),
  })
  .refine((data) => data.texts || data.textsFile, {
